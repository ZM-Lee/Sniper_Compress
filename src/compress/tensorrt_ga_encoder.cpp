...
#ifndef COMPRESS_ENABLE_TENSORRT
...
bool TensorRtGaEncoder::load(const std::string&,
    ...
    throw std::runtime_error(
        "TensorRT g_a backend requested, but compress was built without "
        "COMPRESS_ENABLE_TENSORRT. Reconfigure the src project with TensorRT and "
        "-DCOMPRESS_ENABLE_TENSORRT=ON.");
}
...
#include "compress/preprocess_cuda.h"
